  ...
  render() {
    return (
      <svg className="App-board">
        ...
        <text x="150" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("1")}
          className="App-column">1</text>
        <text x="300" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("2")}
          className="App-column">2</text>
        <text x="450" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("3")}
          className="App-column">3</text>
        <text x="600" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("4")}
          className="App-column">4</text>
        <text x="750" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("5")}
          className="App-column">5</text>
        <text x="900" y="40" font-size="30" text-anchor="middle" fill="black"
          onClick={() => console.log("6")}
          className="App-column">6</text>
        <text x="1050" y="40" font-size="30" text-anchor="middle" fill="black"
